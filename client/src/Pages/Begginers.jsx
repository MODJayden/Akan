...
const Beginners = () => {
  ...
  const beginnerLessons =
    lessons?.filter((lesson) => lesson.level === "Beginner") || [];
  ...
  const checkAnswers = (lessonId) => {
    const lesson = beginnerLessons?.find((l) => l._id === lessonId);
    let correct = 0;
        ...
        <div className="max-w-4xl mx-auto p-4 sm:p-6">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-amber-800 mb-2">
              ...
              Beginner Akan Lessons
            </h1>
            <p className="text-lg text-amber-600">
              Start your journey to mastering Twi pronunciation and basics
            </p>
          </div>
